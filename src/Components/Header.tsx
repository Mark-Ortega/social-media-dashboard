        ...
        <div className="relative">
            <div className="md:flex md:justify-between w-4/5 mx-auto pt-8">
                <div>
                    ...
                    <p className="text-lightMode-darkGrayishBlue dark:text-darkMode-desatBlue">Total Followers: 23,004</p>
                </div>
                <div className="md:hidden pt-5 pb-4">
                    <hr className="border-0 h-px bg-gray-600" />
                </div>
                <div className="toggler max-md:justify-between">
                    <label
                        htmlFor="checkbox"
